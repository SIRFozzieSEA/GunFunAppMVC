...
INSERT INTO REGISTRY (NICKNAME, MAKE, MODEL, SERIAL, CALIBER, BARREL_LENGTH, FRAME_MATERIAL, PURCHASE_COST, PURCHASE_DATE, SIGHTED_DATE, 
	...
	'2022-03-03', 'http://www.fozden.com', false, '1970-01-01', '1970-01-01', '1970-01-01', '');
INSERT INTO REGISTRY (NICKNAME, MAKE, MODEL, SERIAL, CALIBER, BARREL_LENGTH, FRAME_MATERIAL, PURCHASE_COST, PURCHASE_DATE, SIGHTED_DATE, 
	MARKET_COST, MARKET_COST_DATE, MARKET_URL, GUN_IS_DIRTY, LAST_CARRIED_DATE, LAST_CLEANED_DATE, LAST_FIRED_DATE, NOTES) VALUES (
	'Alex', 'Beretta', 'APX', 'SERIAL_02', '9mm', 4.0, 'Composite', '600.00', '2000-01-01', '2000-02-02', 600.00, 
	'2001-03-03', 'http://www.fozden.com', false, '1970-01-01', '1970-01-01', '1970-01-01', '');
INSERT INTO REGISTRY (NICKNAME, MAKE, MODEL, SERIAL, CALIBER, BARREL_LENGTH, FRAME_MATERIAL, PURCHASE_COST, PURCHASE_DATE, SIGHTED_DATE, 
	MARKET_COST, MARKET_COST_DATE, MARKET_URL, GUN_IS_DIRTY, LAST_CARRIED_DATE, LAST_CLEANED_DATE, LAST_FIRED_DATE, NOTES) VALUES (
	'Valerie', 'Heckler & Koch', 'VP9', 'SERIAL_03', '9mm', 4.0, 'Composite', '700.00', '2010-01-01', '2010-02-02', 800.00, 
	'2011-03-03', 'http://www.fozden.com', false, '1970-01-01', '1970-01-01', '1970-01-01', '');
INSERT INTO REGISTRY (NICKNAME, MAKE, MODEL, SERIAL, CALIBER, BARREL_LENGTH, FRAME_MATERIAL, PURCHASE_COST, PURCHASE_DATE, SIGHTED_DATE, 
	MARKET_COST, MARKET_COST_DATE, MARKET_URL, GUN_IS_DIRTY, LAST_CARRIED_DATE, LAST_CLEANED_DATE, LAST_FIRED_DATE, NOTES) VALUES (
	'Harriet', 'Smith & Wesson', '686+', 'SERIAL_04', '357 Magnum', 4.0, 'Metal', '750.00', '2010-01-05', '2010-02-05', 850.00, 
	'2011-03-05', 'http://www.fozden.com', false, '1970-01-01', '1970-01-01', '1970-01-01', '');
	
INSERT INTO PREFERENCES (PREFERENCE_KEY, PREFERENCE_VALUE, PREFERENCE_TYPE) VALUES ('MAX_LOG_DAYS_CARRY', '-30', 'Long');
INSERT INTO PREFERENCES (PREFERENCE_KEY, PREFERENCE_VALUE, PREFERENCE_TYPE) VALUES ('MAX_LOG_DAYS_CLEANING', '-60', 'Long');
INSERT INTO PREFERENCES (PREFERENCE_KEY, PREFERENCE_VALUE, PREFERENCE_TYPE) VALUES ('MAX_LOG_DAYS_SHOT', '-30', 'Long');
...
INSERT INTO PREFERENCES (PREFERENCE_KEY, PREFERENCE_VALUE, PREFERENCE_TYPE) VALUES ('DELETE_MASTER_PASSWORD', 'boboshan69!', 'String');